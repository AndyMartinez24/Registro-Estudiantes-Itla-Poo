                    ...
                    <div class="card mb-4 shadow-sm <?php if ($estudiante->Status == false) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="index.php?menu=view&matricula=<?php echo $matricula; ?>" class="btn btn-sm btn-outline-primary">View</a>|
                                    <a href="index.php?menu=edit&matricula=<?php echo $matricula; ?>" class="btn btn-sm btn-outline-warning">Edit</a>|
                                    <a href="index.php?menu=delete&matricula=<?php echo $matricula; ?>" class="btn btn-sm btn-outline-danger">Delete</a>
                                </div>
