...
<body style="background-color:lightgray">
    <nav class="navbar navbar-expand-lg navbar-light bg-light" i>
        <a class="navbar-brand" href="index.php">Registro de estudiantes POO</a>
                ...
                <?php if (!isset($_GET["menu"])) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="index.php?filtro=Seguridad">Seguridad informatica</a>
                        </div>
                    </li>
                <?php endif ?>
            </ul>
...
<footer id="sticky-footer" class="py-4 bg-dark text-white-50">
    <div class="container text-center">
      <small>Copyright &copy; Warlyn</small>
    </div>
  </footer>
</html>